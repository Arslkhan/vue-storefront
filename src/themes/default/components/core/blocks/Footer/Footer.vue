      ...
      <div class="container">
        <div class="row m0 center-xs">
          ...
          <div class="address-bar col-md-12">
            <span
              >TIDEWAY YARD UNIT T04,&nbsp;&nbsp;125 MORTLAKE HIGH
              STREET,&nbsp;&nbsp;LONDON,&nbsp;&nbsp;SW14 8SN</span
            >
          </div>
          <div class="accepted-cards col-md-12">
            ...
            <span
              ><img src="/assets/fonts/mastercard.svg" alt="mastercard"
            /></span>
            <span><img src="/assets/fonts/visa.svg" alt="visa" /></span>
            <span
              ><img
                src="/assets/fonts/pp-acceptance-medium.webp"
                alt="acceptanc-medium"
            /></span>
          </div>
        </div>
      </div>
