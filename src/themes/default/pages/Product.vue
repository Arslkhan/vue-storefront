...
<!--                  </ul>-->
            ...
            <h1 class="ProductDescription-Title" v-if="getCurrentProduct.costa_instruction">Care and use</h1>
              ...
              <h1 class="ProductDescription-Title ingredients" v-if="getCurrentProduct?.ingredients"> Ingredients </h1>
              <p v-html="getCurrentProduct?.ingredients" class="descriptionText">{{ getCurrentProduct.ingredients }}</p>          
            </div>
